    ...
    <div className = "map-container">
      <div className = "welcome">
        <div>
          ...
          <p> Use the map to find nearby trails and click on the pins to view ______. If you wish to view a more detailed description of the trails, check out the <a href="/list">Trails</a> page. If you wish to find something to eat before or after hiking, we have curated a list of the best nearby food spots in the Food page. If you wish to forage for your own food while hiking, check out the <a href="forage">Foraging</a> page.</p>
          <p>Happy hiking!</p>
        </div>
